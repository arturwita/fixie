...
public interface IDictionaryService{
    ...
    Optional<ActivityDictionary> deleteActivityDictionary(ActivityDictionaryDTO activityDictionaryDTO) throws ActivityDictionaryNotFoundException;
    Optional<ActivityDictionary> updateActivityDictionary(ActivityDictionaryDTO activityDictionaryDTO) throws ActivityDictionaryNotFoundException;
}
